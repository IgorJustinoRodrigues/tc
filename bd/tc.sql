...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `tc`.`tipo_usuario` ;
...
-- Table `tc`.`usuario`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `tc`.`usuario` ;
...
-- Table `tc`.`auditoria`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `tc`.`auditoria` ;
...
-- Table `tc`.`permissao`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `tc`.`permissao` ;
...
-- Table `tc`.`veiculo`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `tc`.`veiculo` ;
...
-- Table `tc`.`registro`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `tc`.`registro` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `tc`.`tipo_usuario_permissao` ;
