...
class Usuario{
    ...
    const CAMPOS = ['id', 'nome', 'foto', 'email', 'fone', 'endereco', 'bairro', 'cidade', 'cargo', 'senha', 'ultimaSenha', 'token', 'status', 'cadastro', 'tipo_usuario'];
    const OBRIGATORIO = ['nome', 'email', 'cargo', 'senha', 'status', 'cadastro', 'tipo_usuario'];
